...
export class Card extends DivComponent {
  ...
  render() {
    ...
    const existInFavoriter = this.appState.favorites.find(
    ...
    this.el.innerHTML = `
        ...
        <div class="card__info">
            <div class="card__tag">
             ${this.cardState.subjecrt ? this.cardState.subjecrt[0] : 'Не задано'}
             </div>
             ...
             ${this.cardState.author_name ? this.cardState.author_name[0] : 'Не задано'}
              ...
              <button class="button_add ${existInFavoriter ? 'button_active' : ''}">
                    ${existInFavoriter
